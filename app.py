...
# LOAD MODELS
# ===============================================================
FORWARD_MODEL_PATH = "ForwardModel_RF_FULLDATA.joblib"
INVERSE_MODEL_PATH = "InverseModel_RF_FULLDATA.joblib"
...
# ===============================================================
pigment_columns = [
    "P-P-F","P-M-F","P-D-F","P-C-F",
    "P-S","M-S","D-S","C-S",
    "P-P-M","P-M-M","P-D-M","P-C-M",
    "Black","IOR","Red","IOY","Yellow",
    "Special Blue","Special Green","Special Red",
    "Yellow-2","White","Orange","Violet","Maroon"
]
lab_cols = ["L", "A", "B"]
...
# ===============================================================
    ...
    A_val = c2.number_input("Target A", -128.0, 127.0, -0.95)
    B_val = c3.number_input("Target B", -128.0, 127.0, 1.94)

    if st.button("🎨 Predict Pigments"):
        target_lab_df = pd.DataFrame([[L_val, A_val, B_val]], columns=["L","A","B"])
